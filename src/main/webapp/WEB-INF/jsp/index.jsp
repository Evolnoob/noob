	...
	<article>
		<div class="banner">
			<div id="sucaihuo" class="fader">
				<img class="slide" src="${ctx}/resources/imgs/banner01.jpg"> <img
					class="slide" src="${ctx}/resources/imgs/banner02.jpg"> <img
					class="slide" src="${ctx}/resources/imgs/banner03.jpg">
