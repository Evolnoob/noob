...
<head>
    <meta charset="gb2312">
    <title>图文列表页_陈枫个人博客 - 一个站在web前端设计之路的女技术员个人博客网站</title>
...
<article>
    ...
    <div class="navtab">
        ...
        <ul class="navlist" id="pageContent">
            ...
            <li><a href="list2.html">网站建设</a></li>
            <li><a href="list2.html">心得笔记</a></li>
            <li><a href="list2.html">推荐工具</a></li>
            <li><a href="http://www.yangqq.com/news/jsex/">JS实例索引</a></li>
        </ul>
        ...
        <ul>
            <li>
                ...
                <div class="bloginfo"><span class="blogpic"><a href="/jstt/css3/2018-03-26/812.html"
                        ...
                        src="images/t01.jpg" alt="帝国cms 首页或者列表无图，不使用默认图片的方法"/></a></span>
            ...
            <li>
                <h3 class="blogtitle"><span><a href="/jstt/css3/" title="css3" target="_blank"
                    ...
                    首页或者列表无图，不使用默认图片的方法</a></h3>
                <div class="bloginfo">
                    <!--<span class="blogpic"><a href="/" title=""><img src="images/b06.jpg"  /></a></span>-->
                    <p>
        ...
        <div class="paihang">
            ...
            <ul>
                ...
                <li><b><a href="/download/div/2014-09-18/730.html" target="_blank">情侣博客模板系列之《回忆》Html30...</a></b>
                    <p><i><img src="images/b05.jpg"/></i>Html5+css3情侣博客模板，主题《回忆》，使用css3技术实现网站动画效果，主题《回忆》,分为四个主要部分，...
                    </p>
                </li>
