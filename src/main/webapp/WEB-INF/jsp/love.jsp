...
<link type="text/css" rel="stylesheet"
	href="${ctx}/resources/love/default.css">
<script type="text/javascript" src="${ctx}/resources/love/jquery.min.js"></script>
<script type="text/javascript" src="${ctx}/resources/love/jscex.min.js"></script>
<script type="text/javascript"
	src="${ctx}/resources/love/jscex-parser.js"></script>
<script type="text/javascript" src="${ctx}/resources/love/jscex-jit.js"></script>
<script type="text/javascript"
	src="${ctx}/resources/love/jscex-builderbase.min.js"></script>
<script type="text/javascript"
	src="${ctx}/resources/love/jscex-async.min.js"></script>
<script type="text/javascript"
	src="${ctx}/resources/love/jscex-async-powerpack.min.js"></script>
<script type="text/javascript" src="${ctx}/resources/love/functions.js"
	charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/resources/love/love.js"
	charset="utf-8"></script>
</head>
	...
	<div id="main" style="width: 80%; height: 500px">
		...
		<div id="wrap">
			<div id="text">
				<div id="code">
					<font color="#FF0000"> 
						<span class="say"> </span><br> <span class="say"> 讲真的，心里没点数么</span><br> 
						<span class="say"> </span><br> <span class="say">搞这些花里胡哨的</span><br>
						<span class="say"> </span><br> <span class="say">神头鬼脸的</span><br>
						<span class="say"> </span><br> <span class="say">有什么用呢</span><br>
						<span class="say"> </span><br> <span class="say">不如找个小姐姐聊天实在！</span><br>
						<span class="say"> </span><br> <span class="say">土老逼LOL</span>
					</font>
				</div>
			</div>
			<div id="clock-box">
